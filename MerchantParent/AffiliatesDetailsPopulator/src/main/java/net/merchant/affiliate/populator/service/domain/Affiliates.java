...
public class Affiliates implements Serializable
{
    ...
    private final static long serialVersionUID = -6314365623223223685L;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("rows", rows).append("count", count).append("additionalProperties", additionalProperties).toString();
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Affiliates) == false) {
            return false;
        }
        Affiliates rhs = ((Affiliates) other);
