...
public class PayoutThisMonth {
	 ...
	 */
	public PayoutThisMonth(Long paid, Long unpaidApprovedComm, Long unpaidPendingComm, Long unpaidDeclinedComm) {
		super();
		this.paid = paid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PayoutThisMonth other = (PayoutThisMonth) obj;
		if (paid == null) {
			if (other.paid != null)
				return false;
	...
	public String toString() {
		return "PayoutThisMonth [paid=" + paid + ", unpaidApprovedComm=" + unpaidApprovedComm + ", unpaidPendingComm="
