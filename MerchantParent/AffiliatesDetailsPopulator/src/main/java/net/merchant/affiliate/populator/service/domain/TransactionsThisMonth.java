...
public class TransactionsThisMonth {
	 ...
	 */
	public TransactionsThisMonth(Long totalCommisions, Long totalSales, Long totalPendingCommisions,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TransactionsThisMonth other = (TransactionsThisMonth) obj;
	...
	public String toString() {
		return "TransactionsThisMonth [totalCommisions=" + totalCommisions + ", totalSales=" + totalSales
